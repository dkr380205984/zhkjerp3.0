...
const quotedPrice = {
  ...
  deleteWeave: (params: DeleteParams) => http.post(`${baseUrl}/quote/product/weave/delete`, params, 'application/json'), // 删除报价单产品织造项
...
const sampleOrder = {
  ...
  timeDelete: (params: DeleteParams) => http.post(`${baseUrl}/order/time/delete`, params, 'application/json'),
