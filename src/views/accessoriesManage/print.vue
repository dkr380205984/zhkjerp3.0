  ...
  <div class="printContainer"
    ...
    <div class="pmain">
      <div class="phead clearfix">
        <div class="fl">
          <div class="ptitle">{{title?title:company_name+'辅料采购单'}}</div>
          <div class="prow">
            <div class="pcol">
              <div class="label">系统采购编号：</div>
          ...
          <div class="thead bgWhite"
            ...
            <div class="trow bgGray">
              ...
              <div class="tcol"
                ...
                <div class="trow">
                  <div class="tcol"
                    style="flex:0.3">辅料信息</div>
                  <div class="tcol"
                    style="flex:0.3">数量</div>
                  <div class="tcol"
                    style="flex:0.3">单价</div>
                  <div class="tcol">参考辅料</div>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="trow">
                  ...
                  <div class="tcol"
                    ...
                    <div class="deleteIcon hoverRed"
                      v-show="editFlag"
                      @click="item.childrenMergeInfo.length>1?$deleteItem(item.childrenMergeInfo,indexChild):$deleteItem(accessoriesManageInfo,index)">删除本行</div>
                  </div>
                </div>
              </div>
            </div>
...
@import '~@/assets/css/accessoriesManage/print.less';
</style>