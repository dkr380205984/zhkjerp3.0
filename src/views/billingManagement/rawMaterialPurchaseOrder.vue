<template>
  <div id="rawMaterialPurchaseOrder"
    v-loading="loading"
    class="bodyContainer">
    <div class="module"
        ...
        <div class="filterCtn">
          ...
          <div class="elCtn">
            <el-select @change="changeRouter"
              ...
              <el-option value=""
                label="全部"></el-option>
              <el-option value="plan"
                label="计划订购"></el-option>
              <el-option value="sup"
                label="补纱订购"></el-option>
              <el-option value="reserve"
                label="预订购"></el-option>
            </el-select>
          </div>
        </div>
          ...
          <div v-for="(item, index) in list"
            ...
            <div class="row">
              ...
              <div v-if="item.plan_id"
                ...
                @click="$router.push('/materialManage/detail?id='+item.plan_id)">{{ item.code }}</div>
              <div v-if="item.reserve_id"
                class="col hoverBlue"
                style="flex: 1.2;cursor:pointer"
                @click="$router.push('/materialPlanOrder/detail?id='+item.reserve_id)">{{ item.code }}</div>
              <div v-if="item.sup_id"
                class="col hoverBlue"
                style="flex: 1.2;cursor:pointer"
                @click="$router.push('/materialManage/detail?id='+item.sup_id)">{{ item.code }}</div>
              ...
              <div class="col"
                style="flex: 0.7">{{ item.user_name }}</div>
              ...
              <div class="tableCtn"
                ...
                <div class="tbody">
                  <div class="trow"
                    ...
                    <div class="tcol">{{ itemChild.settle_price ? $toFixed(itemChild.settle_price,3,true) + '元' : '未填写' }}</div>
                  </div>
                </div>
              </div>
            </div>
