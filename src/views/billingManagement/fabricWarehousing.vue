    ...
    <div class="module"
      ...
      <div class="listCtn">
        <div class="filterCtn">
          ...
          <div class="elCtn">
            <el-cascader placeholder="筛选面料名称"
...
export default Vue.extend({
    ...
    getList() {
      ...
      materialStock
        .list({
          ...
          material_name: this.material_name.length ? this.material_name[1] : '',
  ...
  computed: {
    ...
    yarnTypeList() {
      const finded = this.$store.state.api.yarnType.arr.find((item: any) => item.label === '面料')
      return finded
