      ...
      <div class="listCtn">
          ...
          <div v-for="(item, index) in list" :key="index">
            <div class="row">
              ...
              <div
                ...
                @click="$router.push('/materialStock/detail?id=' + item.order_id)"
              >
                {{ item.doc_code }}
              </div>
              <div class="col">
              ...
              <div class="col" :style="item.deduct_price ? 'color:red' : ''">
                {{ $toFixed(item.deduct_price || 0, 3, true) }}元
              </div>
        ...
        <div style="margin-top: 20px">
          ...
          <span style="line-height: 35px; margin-left: 40px">
            半次(b品)数量：
            <span class="green" style="font-weight: bold">
              {{ $toFixed(additional.total_part_shoddy_number || 0, 3, true) }} 件
            </span>
          </span>
          <span style="line-height: 35px; margin-left: 40px">
            全次数量：
            <span class="green" style="font-weight: bold">
              {{ $toFixed(additional.total_shoddy_number || 0, 3, true) }} 件
            </span>
          </span>
          <span style="line-height: 35px; margin-left: 40px">
            扣款金额：
