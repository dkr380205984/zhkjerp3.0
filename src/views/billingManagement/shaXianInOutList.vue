    ...
    <div class="module"
      ...
      <div class="listCtn">
        <div class="filterCtn">
          ...
          <div class="elCtn">
            <el-cascader placeholder="筛选纱线名称"
              v-model="shaxianName"
        ...
        <div class="list">
          ...
          <div v-for="(item, index) in list"
            ...
            <div class="row">
              ...
              <div class="col">
                {{ stockTypeList[item.action_type - 1] ? stockTypeList[item.action_type - 1].name : '无出入库类型' }}
              </div>
              <div class="col">
            ...
            <div v-show="item.isShow"
              ...
              <div class="tableCtn">
                ...
                <div class="tbody">
                  <div class="trow"
                    v-for="itemSon in item.detail.info_data"
                    :key="itemSon.id + 'itemSon'">
                    <div class="tcol">
...
export default Vue.extend({
  ...
  methods: {
    ...
    getFilters() {
      ...
      this.shaxianName = query.shaxianName ? (query.shaxianName as string).split(',') : []
    ...
    changeRouter(ev?: any) {
      ...
      this.$router.push(
        '/billingManagement/shaXianInOutList?page=' +
          this.page +
          '&keyword=' +
          this.keyword +
          '&client_id=' +
          ...
          this.group_id +
          '&shaxianName=' +
          encodeURIComponent(this.shaxianName) +
          '&action_type=' +
          this.action_type +
          '&store_id=' +
          this.store_id +
    ...
    getList() {
      ...
      materialStock
        .list({
          ...
          material_name: this.shaxianName.length ? this.shaxianName[1] : '',
          action_type: this.action_type,
          user_id: this.user_id,
          store_id: this.store_id,
          client_id: this.client_id[2] || this.$route.query.single_client_id || '',
          limit: this.limit,
          page: this.page
        })
        .then((res) => {
  ...
  computed: {
    ...
    yarnTypeList() {
      const finded = this.$store.state.api.yarnType.arr.find((item: any) => item.label === '纱线')
      return finded
        ? finded.children.map((itemChild: any) => {
            return {
