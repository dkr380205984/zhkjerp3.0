      ...
      <div class="listCtn">
        ...
        <div class="list">
          <div class="row title">
            ...
            <div class="col" style="flex: 0.5">合计调取数量</div>
            <div class="col" style="flex: 0.5">合计调取金额</div>
...
<script lang="ts">
import Vue from 'vue'
import { order, listSetting, exportExcel, client, materialPlan, store, materialStock } from '@/assets/js/api'
