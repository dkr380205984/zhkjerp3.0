<template>
  <div id="packingOrder" v-loading="loading" class="bodyContainer">
    <div class="module" v-loading="mainLoading" element-loading-text="正在导出文件中....请耐心等待">
      ...
      <div style="display: flex; justify-content: space-between; padding: 15px 35px 0">
        ...
        <div class="tab active">包装订购单</div>
      ...
      <div class="listCtn">
        ...
        <div class="list">
          <div class="row title">
            ...
            <div class="col" style="flex: 1.3">订购单号</div>
          ...
          <div v-for="(item, index) in list" :key="index">
            <div class="row">
              ...
              <div
                ...
                @click="$router.push('/packManage/detail?id=' + item.top_order_id)"
              >
                {{ item.code }}
              </div>
              <div
            ...
            <div v-show="item.isShow" style="border: 1px solid #e8e8e8; transform: translateY(-1px); background: #eee">
              <div class="tableCtn" style="position: unset">
                <div class="thead">
                  <div class="trow">
        ...
        <div style="margin-top: 20px">
          <span style="line-height: 35px; margin-left: 40px">
            ...
            <span class="green" style="font-weight: bold">
              {{ $toFixed(additional.total_number / 10000, 3, true) }} 万个
            </span>
          </span>
          <span style="line-height: 35px; margin-left: 40px">
            合计订购金额：
...
<script lang="ts">
import Vue from 'vue'
import { order, listSetting, client, packManage, check } from '@/assets/js/api'
...
export default Vue.extend({
  ...
  methods: {
    ...
    changeRouter(ev?: any) {
      ...
      this.$router.push(
        '/billingManagement/packingOrder?page=' +
          this.page +
          '&keyword=' +
          this.keyword +
          '&client_id=' +
...
<style lang="less">
@import '~@/assets/css/billingManagement/packingOrder.less';
</style>    