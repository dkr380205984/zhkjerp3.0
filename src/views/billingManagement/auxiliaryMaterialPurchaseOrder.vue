<template>
  <div id="auxiliaryMaterialPurchaseOrder"
    v-loading="loading"
    class="bodyContainer">
    <div class="module"
        ...
        <div class="list">
          ...
          <div v-for="(item, index) in list"
            ...
            <div class="row">
              ...
              <div class="col"
                :style="item.total_push_number>item.total_number?'color:red':''">{{ (+item.total_push_number).toFixed(2) }}</div>
              ...
              <div class="col"
                style="flex: 0.5">{{ item.user_name }}</div>
