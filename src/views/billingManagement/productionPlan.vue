        ...
        <div class="list">
          ...
          <div v-for="(item, index) in list" :key="index">
            <div class="row">
              ...
              <div class="col" style="flex: 1.3">{{ $toFixed(item.total_price, 3, true) }}</div>
              <div class="col" style="flex: 1.9">
                ...
                （<span :class="item.total_real_number - item.total_number >= 0 ? 'green' : 'red'"
                  >{{ $toFixed(((item.total_real_number - item.total_number) / item.total_number) * 100 || 0) }}%</span
                >）
              </div>
              ...
              <div class="col">
                ...
                <div v-else-if="item.is_check === 3" class="green">已完成</div>
                <div v-else class="red">已逾期</div>
              </div>
              <div class="col">
