      ...
      <div class="listCtn">
        ...
        <div class="list">
          <div class="row title">
            ...
            <div class="col" style="flex: 0.5">合计完成数量</div>
            <div class="col" style="flex: 0.5">合计完成金额</div>
          ...
          <div v-for="(item, index) in list" :key="index">
            <div class="row">
              ...
              <div class="col" style="flex: 0.5">{{ item.total_real_number }}</div>
              <div class="col" style="flex: 0.5">{{ item.total_real_price }}</div>
              <div class="col">
...
<script lang="ts">
import Vue from 'vue'
import { order, listSetting, exportExcel, client, productionPlan, check } from '@/assets/js/api'
