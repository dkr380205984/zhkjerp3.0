    ...
    <div class="module"
      ...
      <div class="listCtn">
          ...
          <div v-for="(item, index) in list"
            ...
            <div class="row">
              ...
              <div class="col hoverBlue"
                ...
                @click="$router.push('/settlement/paymentDetail?id='+item.client.id+'&type='+item.client.client_type.name)">{{ item.code || '无' }}</div>
              <div class="col hoverBlue"
                style="
                  cursor: pointer;
                  white-space: nowrap;
        ...
        <div style="margin-top: 20px">
          <span style="line-height: 35px; margin-left: 40px">合计付款金额：
