          ...
          <div v-for="(item, index) in list"
            ...
            <div class="row">
              ...
              <div class="col hoverBlue"
                ...
                @click="$router.push('/settlement/collectionDetail?id='+item.client.id)">{{ item.code || '无' }}</div>
              <div class="col hoverBlue"
                style="
                  cursor: pointer;
                  white-space: nowrap;
        ...
        <div style="margin-top: 20px">
          <span style="line-height: 35px; margin-left: 40px">合计开票金额：
            <span style="font-weight: bold"
              class="green">
              {{ $toFixed(additional.total_price_rmb / 10000,3,true) }} 万元 / {{$toFixed(additional.total_price_usd / 10000,3,true)}}万美元
            </span>
          </span>
        </div>
        <div class="pageCtn">
