      ...
      <div class="listCtn">
        ...
        <div class="list">
          <div class="row title">
            ...
            <div class="col" style="flex: 0.5">合计加工数量</div>
            <div class="col" style="flex: 0.5">合计加工金额</div>
...
<script lang="ts">
import Vue from 'vue'
import { order, listSetting, exportExcel, client, materialProcess, check } from '@/assets/js/api'
