      ...
      <div class="listCtn">
        ...
        <div class="filterCtn clearfix">
          <div class="btn backHoverBlue fr"
            ...
            @click="updateNumber(1)">计件更新（按订单）</div>
          <div class="btn backHoverBlue fr"
            style="margin-left: 20px"
            @click="updateNumber(2)">计件更新（按员工）</div>
          <div class="btn backHoverBlue fr"
              ...
              <el-table ref="multipleTable"
                ...
                <el-table-column label="次品原因"
                  ...
                  <template slot-scope="scope">
                    ...
                    <div v-else
                      style="color: rgba(0, 0, 0, 0.25)">无</div>
                  </template>
                </el-table-column>
                ...
                <el-table-column label="操作"
                  ...
                  <template slot-scope="scope">
                    <div style="display: flex; justify-content: center">
                      <div class="hoverOrange opr"
                        @click="lostEdit([scope.row.id])">修改</div>
                      <div class="hoverBlue opr"
                        @click="changeStatus(scope.row)">审核</div>
                      <div class="hoverRed opr"
                        @click="lostDelete(scope.row.id)">删除</div>
                    </div>
                  </template>
                </el-table-column>
              </el-table>
            </el-tab-pane>
            <el-tab-pane label="计时结算表"
              name="2">
      ...
      <div class="main">
        <div class="btnCtn"
          ...
          <div class="btn backHoverOrange"
            @click="lostEdit()">批量修改</div>
          <div class="btn backHoverBlue"
            @click="lostAgree">批量通过</div>
          <div class="btn backHoverRed"
            style="margin-left: 32px"
            @click="lostDelete(false)">批量删除</div>
        </div>
        <div class="btnCtn">
          <div class="borderBtn"
            @click="$router.go(-1)">返回</div>
          <div class="btn backHoverBlue"
            @click="exportExcel">导出结算报表</div>
        </div>
      </div>
    </div>
    <div class="popup"
