  ...
  <div class="bodyContainer" id="materialManageDetail" v-loading="loading">
      ...
      <div class="detailCtn">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="text">
              {{ $toFixed(materialPlanInfo.total_plan_number || materialSupplementInfo.total_plan_number, 3, true) }}
            </div>
          </div>
          <div class="col">
            <div class="label">总订购数：</div>
            <div class="text">
              {{ $toFixed(materialPlanInfo.total_order_number || materialSupplementInfo.total_order_number, 3, true) }}
            </div>
          </div>
          <div class="col">
            ...
            <div class="text">
              {{
                $toFixed(
                  materialPlanInfo.total_process_number || materialSupplementInfo.total_process_number || 0,
                  3,
                  true
                )
              }}
              ...
              <div class="col">
                <div class="col">
                  ...
                  <div class="text">
                    {{
                      $toFixed(
                        item.info_data.reduce((total, cur) => total + Number(cur.number), 0),
                        3,
                        true
                      )
                    }}
            ...
            <div class="row">
              ...
              <div class="col">
                ...
                <div class="text">
                  {{
                    $toFixed(
                      item.info_data.reduce((total, cur) => total + Number(cur.number) * Number(cur.price), 0),
                      3,
                      true
                    )
                  }}元
    ...
    <zh-check
      ...
      @afterCheck="
        (ev) => {
          checkType === 2
            ? (materialOrderList.find((item) => Number(item.id) === Number(materialOrderIndex)).is_check = ev)
            : (materialStockLog.find((item) => Number(item.id) === Number(materialStockIndex)).is_check = ev)
        }
      "
      :show="checkFlag"
