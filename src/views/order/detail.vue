      ...
      <div class="module">
        <div class="titleCtn">
          <div class="title"
            ...
            <el-switch style="margin-left:8px"
              v-model="show_financial">
            </el-switch>
          </div>
        </div>
        <template v-if="show_financial">
          <div class="titleIn"
