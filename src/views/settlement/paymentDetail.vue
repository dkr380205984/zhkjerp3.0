<template>
  <div id="paymentDetail" class="bodyContainer">
    ...
    <div class="module" id="单据列表">
      ...
      <div class="listCtn" v-loading="listLoading">
        <!-- 物料订购 -->
        <template v-if="clientType === 2">
          <div class="filterCtn">
            <div class="elCtn">
          ...
          <div class="filterCtn">
            ...
            <div class="btn backHoverBlue" @click="changeShowAll(materialOrderList)">
              <svg class="iconFont" aria-hidden="true">
                <use xlink:href="#icon-xiugaidingdan"></use>
              </svg>
          ...
          <div class="list">
            ...
            <div v-for="(item, index) in materialOrderList" :key="index">
              <div class="row">
                <div class="col" style="flex: 0.1">
                  <el-checkbox v-model="item.checked" @change="(ev) => getCheckInfo(ev, item, materialOrderCheckList)">
                  </el-checkbox>
                </div>
                <div class="col blue" style="cursor: pointer" @click="openMaterialOrder(item)">{{ item.code }}</div>
                <div
                  class="col blue"
                  style="cursor: pointer"
                ...
                <div class="col numberWidth" :class="{ red: item.total_push_number > item.total_number }">
              ...
              <div v-if="item.isShow" style="border: 1px solid #e8e8e8; transform: translateY(-1px); background: #eee">
            ...
            <div style="margin-top: 20px">
              <span style="line-height: 35px; margin-left: 40px">
                ...
                <span class="green" style="font-weight: bold">
                  ...
                  <span class="unit">{{
                    $route.query.type === '纱线原料单位' ? '吨' : $route.query.type === '面料原料单位' ? '千米' : '万'
                  }}</span>
                </span>
              </span>
              <span style="line-height: 35px; margin-left: 40px">
        ...
        <template v-else-if="clientType === 3">
          ...
          <div class="filterCtn clearfix">
            ...
            <div class="btn backHoverBlue" @click="changeShowAll(materialProcessList)">
              <svg class="iconFont" aria-hidden="true">
                <use xlink:href="#icon-xiugaidingdan"></use>
              </svg>
              <span class="text">{{ showAllFlag ? '全部展开' : '全部收起' }}</span>
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <div
                      :class="item.detail.plan_code ? 'hoverBlue text' : 'text'"
                      :style="item.detail.plan_code ? { cursor: 'pointer' } : {}"
                      @click="item.detail.plan_code ? $router.push('/materialManage/detail?id=' + item.plan_id) : ''"
                    >
                      {{ item.detail.plan_code || '无' }}
                    </div>
                  </div>
        ...
        <template v-else-if="clientType === 4">
          ...
          <div class="filterCtn clearfix">
            ...
            <div class="btn backHoverBlue" @click="changeShowAll(productionPlanList)">
              <svg class="iconFont" aria-hidden="true">
                <use xlink:href="#icon-xiugaidingdan"></use>
              </svg>
              <span class="text">{{ showAllFlag ? '全部展开' : '全部收起' }}</span>
            ...
            <div v-for="(item, index) in productionPlanList" :key="index">
              <div class="row">
                ...
                <div
                  ...
                  style="cursor: pointer"
                  @click="
                    $openUrl('/productionPlan/detail?id=' + item.top_order_id + '&sampleOrderIndex=' + item.order_id)
                  "
                >
                  {{ item.code }}
                </div>
                ...
                >
                  {{ $toFixed(item.total_real_number, 3, true) }} ({{
                    ...
                    parseInt(
                      ((Number(item.total_real_number) - Number(item.total_number)) / Number(item.total_number)) * 100
                    ) + '%'
                  }})
                </div>
        ...
        <template v-else-if="clientType === 11">
          ...
          <div class="filterCtn clearfix">
            ...
            <div class="btn backHoverBlue" @click="changeShowAll(packOrderList)">
              <svg class="iconFont" aria-hidden="true">
                <use xlink:href="#icon-xiugaidingdan"></use>
              </svg>
              <span class="text">{{ showAllFlag ? '全部展开' : '全部收起' }}</span>
          ...
          <div class="list">
            <div class="row title">
              <div class="col" style="flex: 0.1">
                <el-checkbox v-model="checkAll" @change="(ev) => checkAllInfo(ev, packOrderList, packOrderCheckList)">
                </el-checkbox>
              </div>
              <div class="col">订购单号</div>
              <div class="col">关联单号</div>
        ...
        <template v-else-if="clientType === 13">
          ...
          <div class="filterCtn clearfix">
            ...
            <div class="btn backHoverBlue" @click="changeShowAll(boxManageList)">
              <svg class="iconFont" aria-hidden="true">
                <use xlink:href="#icon-xiugaidingdan"></use>
              </svg>
              <span class="text">{{ showAllFlag ? '全部展开' : '全部收起' }}</span>
          ...
          <div class="list">
            <div class="row title">
              <div class="col" style="flex: 0.1">
                <el-checkbox v-model="checkAll" @change="(ev) => checkAllInfo(ev, packOrderList, boxManageCheckList)">
                </el-checkbox>
              </div>
            ...
            <div v-for="(item, index) in boxManageList" :key="index">
              <div class="row">
                ...
                <div class="col blue" style="cursor: pointer" @click="$openUrl('/boxManage/boxDetail?id=' + item.id)">
                  {{ item.code }}
                </div>
