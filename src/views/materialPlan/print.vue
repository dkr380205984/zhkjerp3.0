            ...
            <div class="tableCtn"
              ...
              <div class="thead bgWhite"
                ...
                <div class="trow">
                  ...
                  <div class="tcol"
                    style="flex:2">
                    {{numberAutoMethod(item.childrenMergeInfo.reduce((total,cur)=>total+numberAutoMethod(cur.final_number,1),0),1)}}{{item.childrenMergeInfo[0].unit}}
                  </div>
                </div>
...
export default Vue.extend({
  ...
  mounted() {
    const proIdArr = this.$route.query.proId ? JSON.parse(this.$route.query.proId as string) : []
    ...
    materialPlan
      ...
      .then((res) => {
        ...
        this.productInfo = this.$route.query.proId
          ? this.otherInfo.material_plan_data.filter((item: any) => {
              return proIdArr.indexOf(item.id) !== -1
            })
          : this.otherInfo.material_plan_data
        // 物料根据所选产品信息重新计算
