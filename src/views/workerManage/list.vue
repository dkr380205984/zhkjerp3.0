      ...
      <div class="listCtn">
        <div class="filterCtn">
          ...
          <div class="elCtn">
            ...
            <el-tooltip class="item" effect="dark" content="保存部门筛选" placement="top">
              <i class="el-icon-upload hoverOrange" @click="$setLocalStorage('department', department, true)"></i>
            </el-tooltip>
          </div>
          <div class="elCtn">
            <el-select @change="changeRouter" v-model="status" placeholder="员工状态筛选" clearable>
              <el-option value="1" label="在职"></el-option>
              <el-option value="2" label="离职"></el-option>
            </el-select>
          </div>
          <div class="elCtn">
            <el-select @change="changeRouter" v-model="type" placeholder="工种筛选" clearable>
        ...
        <div class="list">
          ...
          >
            ...
            <el-table-column prop="status" label="本月合计工资">
