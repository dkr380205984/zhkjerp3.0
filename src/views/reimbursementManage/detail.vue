<template>
  <div id="reimbursementManageDetail"
      ...
      <div class="detailCtn">
        <div class="checkCtn">
          <el-tooltip class="item"
            effect="dark"
            :content="receiptInfo.status===3?'点击查看异常处理办法':'点击查看审核日志'"
            placement="bottom">
            <img :src="receiptInfo.status | checkFilter"
              @click="lookDetailLog" />
          </el-tooltip>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="text">
              <span v-for="(item, index) in receiptInfo.certificate"
                :key="item + index"
      ...
      <div class="tableCtn">
        ...
        <div class="tbody">
          <div class="trow"
            ...
            <div class="tcol"
              style="flex: 1.5">{{ item.name || '无' }}</div>
        ...
        <div class="thead">
          <div class="trow">
            <div class="tcol"
              style="border-right: none">合计费用</div>
            <div class="tcol"></div>
      ...
      <div class="main">
        <div class="btnCtn">
          ...
          <div class="buttonList"
            ...
            <div v-if="receiptInfo.status + 1 !== 2"
            ...
            <div class="btn backHoverBlue"
              @click="$openUrl('/reimbursementManage/print?id=' + $route.query.id)">
              <svg class="iconFont"
                aria-hidden="true">
        ...
        <div class="contentCtn">
          <div class="row">
            ...
            <div class="info"
              ...
              <el-radio v-model="reviewerParams.status"
                :label="2">通过</el-radio>
              <el-radio v-model="reviewerParams.status"
                :label="3">驳回</el-radio>
            </div>
    ...
    <div class="popup"
      v-show="detailCheckFlag">
      <div class="main"
        style="min-width: 1000px">
        <div class="titleCtn">
          <span class="text">报销单审核详情</span>
          <div class="closeCtn"
            @click="detailCheckFlag = false">
            <span class="el-icon-close"></span>
          </div>
        </div>
        <div class="contentCtn">
          <div class="listCtn">
            <div class="list">
              ...
              <div class="row"
                ...
                <div class="col"
                  style="flex: 0.5"
                  :class="{ red: item.status === 3, green: item.status === 2 }">
                  {{ item.status === 2 ? '通过' : '驳回' }}
                </div>
